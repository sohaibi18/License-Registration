...
{
    public function display_For_Verification($userid)
    {
    ...
    public function finance_verified($userid, $licenseappid): RedirectResponse
    {
...
//            stored in $payment will be remain same in table as previously.
        ...
        return redirect('/application/finance/verification/{userid}')->with('success', 'application verified successfully');
    }
}
